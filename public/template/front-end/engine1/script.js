...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"blinds",prev:"",next:"",duration:26*100,delay:29*100,width:960,height:360,autoPlay:true,playPause:false,stopOnHover:true,loop:false,bullets:1,caption:false,captionEffect:"slide",controls:true,onBeforeStep:function(i,c){return (i+1 + Math.floor((c-1)*Math.random()))},images:0});