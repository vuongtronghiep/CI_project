...
<html>
<head>
	<title> Các sản phẩm giảm giá</title>
...
<body>  
	...
	<ul>
		...
		<div class="search">
			<form action="<?php echo ARSENAL_BASE_URL;?>timkiem/search" method="get">
				<input type="text" name="txt_search" placeholder="Tìm kiếm ản phẩm, mọi thứ" size="40px">
	...
	<div class="product_review">
		...
		<?php }?>
				...
				<!main>
	<div class="main">
		<p class="sale_text"> Các sản phẩm đang trong thời gian giảm giá</p>
	<?php foreach ($giamgia->result_array() as $row) { 
				$anhminhhoa = 'public/template/back-end/image/sanpham/'.$row['anhbia'];
   				$anhminhhoa = "<img src='$anhminhhoa', height='250px', width='221px' class='magnify'>";
			?>
		<div class="product_main2">
			...
			<p class="product_main_price_text">Giá:</p>
			<div class="product_main_price"><?php echo number_format(round(floor($aftersale),-3)).' VNĐ';?></div>
