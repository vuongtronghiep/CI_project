<?php
 ...
 ?>
 <body>
	 <form action="<?php echo ARSENAL_BASE_URL;?>admin/qldanhmuc/timkiem" method="get" class="tk">
 	...
 	<div class="maindm">
				<div class="panel panel-default">
				  ...
				  <div class="panel-heading"> <h5 style="font-weight:bold">DANH SÁCH DANH MỤC</h5></div>
