	...
	<form action="<?php echo ARSENAL_BASE_URL;?>admin/qlsanpham/timsanpham" method="get" class="tk">
		...
		<div class="main">
				<div class="panel panel-default">
				  ...
				  <div class="panel-heading"> <h5 style="font-weight:bold">DANH SÁCH SẢN PHẨM 
					...
					<tbody>
					    ...
					    <?php
					     ...
					     ?>
							...
							<td><?php echo number_format(round(floor($row['gia']),-3));?></td>
							<td><?php echo number_format(round(floor($row['giasaukhuyenmai']),-3)); ?></td>
