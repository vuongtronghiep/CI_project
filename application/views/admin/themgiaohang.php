...
<body>
	...
	<div class="main3">
		<form action="" method="post" class="formgh">
			Mã Nhân viên: <select name='nhanvien'>
				<option value=""></option>
			</select>

			Mã đơn hàng 1: <select name='order_id1'>
				<option value=""></option>
			</select>

			Mã đơn hàng 1: <select name='order_id2'>
				<option value=""></option>
			</select>
			
			Mã đơn hàng 1: <select name='order_id3'>
				<option value=""></option>
			</select>
